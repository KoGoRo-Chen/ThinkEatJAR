-- Inserting data into `cmt` table
INSERT INTO `thinkeat`.`cmt` (`cmtContext`) VALUES ('Great place, loved the food!');
INSERT INTO `thinkeat`.`cmt` (`cmtContext`) VALUES ('The service was a bit slow.');
