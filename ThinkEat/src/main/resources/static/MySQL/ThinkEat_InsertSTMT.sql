...
INSERT INTO `thinkeat`.`user` (`id`, `enabled`, `nick_name`, `password`, `token_expired`, `username`) VALUES ('1', '1', '一般會員', '$2y$10$oTWA1mrN67z2niF7d8HOduSaQ70cBtUhcqfoywhTnFkF5cZ9VozRG', '0', 'testuser');
INSERT INTO `thinkeat`.`user` (`id`, `enabled`, `nick_name`, `password`, `token_expired`, `username`) VALUES ('2', '1', '管理員', '$2y$10$jPJux4x4yu9ZJ8Bepb0jSeAlPaYjq.vbWxsOFh4VzrZGOmu4HkvqS', '0', 'admin');
INSERT INTO `thinkeat`.`user` (`id`, `enabled`, `nick_name`, `password`, `token_expired`, `username`) VALUES ('3', '1', '創辦者', '$2y$10$DHUH5Ay5OdgFMwLIhcT.4u3XpQsbiDwFwlY.AKuh2ZLAKNWsif7su', '0', 'founder');
